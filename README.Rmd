...
[![CRAN downloads](https://cranlogs.r-pkg.org/badges/adaptDiag)](https://CRAN.R-project.org/package=adaptDiag)
[![Codecov test coverage](https://codecov.io/gh/graemeleehickey/adaptDiag/graph/badge.svg)](https://app.codecov.io/gh/graemeleehickey/adaptDiag)
...
influenced by the seminal article by Broglio et al. (2014).
