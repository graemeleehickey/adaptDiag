...
vignette: >
  %\VignetteIndexEntry{Example: GeneSearch Breast Lymph Node Assay}
...
We add in an additional criterion that the study cannot stop for early success or futility until a fixed number of reference positive cases are observed. We implement these 2 criteria and extract the operating characteristic as follows:
...
We can then use this to understand how the power changes with the assumed true prevalence value, as
