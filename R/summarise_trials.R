...
#'     result in success, irrespective of whether it is an early stop of success
#'     or not. When the performance goals are set equal to the respective true
#'     values, the power returned is the type I error.
